...
var predefinedClouds = map[string]*AzureCloudSettings{
	AzurePublic: {
		...
		Properties: map[string]string{
			...
			"resourceManagerResourceId": "https://management.azure.com",
		},
	},
	AzureChina: {
		...
		Properties: map[string]string{
			...
			"resourceManagerResourceId": "https://management.chinacloudapi.cn",
		},
	},
	AzureUSGovernment: {
		...
		Properties: map[string]string{
			...
			"resourceManagerResourceId": "https://management.usgovcloudapi.net",
		},
	},
}
